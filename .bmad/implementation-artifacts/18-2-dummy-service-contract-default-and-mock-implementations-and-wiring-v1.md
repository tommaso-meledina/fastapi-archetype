...
4. Factory in `services/factory.py`: build_dummy_service(settings) returns default or mock by settings.profile.
5. Dependency get_dummy_service used by v1 routes; routes use Depends(get_dummy_service) and do not import concrete module.
